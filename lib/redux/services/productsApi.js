...
export const productsApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        getProductsByCategory: builder.query({
            query: ({ category, per_page = 50, page = 1, brand_id, order_by, min_price, max_price }) => {
                const params = new URLSearchParams();
                ...
                // params.append('pinned_first', true);
        ...
        getBrandsByCategory: builder.query({
            query: ({ category_slug }) => {
                ...
                return `brands/by-category?${params.toString()}`;
            },
            providesTags: [{ type: 'Brands', id: 'LIST_BY_CATEGORY' }],
        }),
    }),
