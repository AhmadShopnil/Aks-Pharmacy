...
//       <div className="relative flex flex-col md:flex-row gap-4 bg-white rounded-md p-4 border border-gray-100 shadow-sm transition-all duration-300">
...
//           className="relative flex-1 flex items-center justify-center cursor-crosshair select-none overflow-hidden rounded-md bg-gray-500 h-[350px] md:h-[450px]"
//         >
//           <img
//             src={activeImage}
//             alt="Product"
//             className={`max-w-full h-auto max-h-[400px] object-contain transition-all duration-500 ${isZooming ? 'opacity-0' : 'opacity-100'}`}
//           />
