    ...
    <div className="border p-1.5 md:p-3 border-gray-100 hover:shadow-lg transition duration-300 relative
      ...
      <Link
        ...
        <button
          ...
          className={`absolute top-4 right-4 z-40 p-2 rounded-full shadow-md transition-all duration-300 group/wishlist ${isInWishlist ? 'bg-pink-50 text-pink-600' : 'bg-white/80 text-gray-400 hover:text-pink-600 hover:bg-white'
            }`}
        >
