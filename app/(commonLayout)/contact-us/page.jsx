                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        >
                            ...
                            <a href="tel:+1234567890" className="text-lg font-bold text-emerald-600 hover:underline">+1 (234) 567-890</a>
                        </motion.div>
                        ...
                        >
                            ...
                            <a href="mailto:support@akspharmacy.com" className="text-lg font-bold text-[#0784BB] hover:underline">support@aks.com</a>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-slate-500 mb-4">Our main retail center.</p>
                            <p className="text-lg font-bold text-slate-800">123 Health Ave, Medical District, NY</p>
                        </motion.div>
                    </div>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                type="submit"
                                className="cursor-pointer w-full bg-[#0784BB] text-white rounded-2xl py-3 md:py-4 font-bold text-lg shadow-lg shadow-emerald-200 hover:bg-emerald-700 transition-all flex items-center justify-center gap-3"
                            >
                                Send Message
                                <Send size={20} />
                            </motion.button>
